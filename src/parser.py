...
It only extracts information that will later be used by the splitter.
...
class PKTRecord:
    ...
    # Text inside quotation marks (unchanged)
    label: str
...
class PKTParser:
    ...
    def read(self) -> List[PKTRecord]:
        ...
        The parser NEVER changes the content of the file.
        """
    ...
    def parse_line(
        ...
        # Preserve the label EXACTLY as it appears.
        label = line[first_quote + 1:last_quote]

        # Read everything before the label.
